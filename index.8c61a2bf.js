 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ut(t,e,n=!1){const r=await V(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Dt._forOperation(t,"link",r)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Mt(t,e,n=!1){var r;const{auth:i}=t,s="reauthenticate";try{const r=await V(t,Pt(i,s,e,t),n);b(r.idToken,i,"internal-error");const o=H(r.idToken);b(o,i,"internal-error");const{sub:a}=o;return b(t.uid===a,i,"user-mismatch"),Dt._forOperation(t,s,r)}catch(t){throw"auth/user-not-found"===(null===(r=t)||void 0===r?void 0:r.code)&&p(i,"user-mismatch"),t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bt(t,e,n=!1){const r="signIn",i=await Pt(t,r,e),s=await Dt._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}function jt(t,e,n,i){return(0,r.getModularInstance)(t).onAuthStateChanged(e,n,i)}new WeakMap;const Ft="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D{constructor(t,e,n,r){this.indexId=t,this.collectionGroup=e,this.fields=n,this.indexState=r}}D.UNKNOWN_ID=-1;function L(t){return"IndexedDbTransactionError"===t.name}
/**
 * @license
...
//# sourceMappingURL=index.8c61a2bf.js.map
