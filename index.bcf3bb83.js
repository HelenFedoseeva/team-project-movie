 ...
 * limitations under the License.
 */
const R="firebase-heartbeat-store";let O=null;function k(){return O||(O=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(t,e)=>{if(0===e)t.createObjectStore(R)}}).catch((t=>{throw E.create("idb-open",{originalErrorMessage:t.message})}))),O}async function C(t,e){var n;try{const n=(await k()).transaction(R,"readwrite"),r=n.objectStore(R);return await r.put(e,N(t)),n.done}catch(t){if(t instanceof o.FirebaseError)h.warn(t.message);else{const e=E.create("idb-set",{originalErrorMessage:null===(n=t)||void 0===n?void 0:n.message});h.warn(e.message)}}}function N(t){return`${t.name}!${t.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class kt extends Rt{static credential(t,e){return Et._fromParams({providerId:kt.PROVIDER_ID,signInMethod:kt.GOOGLE_SIGN_IN_METHOD,idToken:t,accessToken:e})}static credentialFromResult(t){return kt.credentialFromTaggedObject(t)}static credentialFromError(t){return kt.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthIdToken:e,oauthAccessToken:n}=t;if(!e&&!n)return null;try{return kt.credential(e,n)}catch(t){return null}}constructor(){super("google.com"),this.addScope("profile")}}kt.GOOGLE_SIGN_IN_METHOD="google.com",kt.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=index.bcf3bb83.js.map
